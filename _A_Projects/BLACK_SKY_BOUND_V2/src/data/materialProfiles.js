...
export const MATERIAL_PROFILES = Object.freeze({
  ...
  [MaterialProfileId.SOIL_GRASS]: profile(MaterialProfileId.SOIL_GRASS, MaterialFamily.TERRAIN, 'terrainMaterial.soil_grass_authored_layered_pbr_v2', '#273b25', { roughness: 0.9, wetness: 0.12, nightReveal: 0.56, density: 0.44, windSway: 0.08, tags: ['soil', 'grass', 'layered_pbr', 'reference_derived'] }),
  ...
  [MaterialProfileId.WATER_DARK]: profile(MaterialProfileId.WATER_DARK, MaterialFamily.TERRAIN, 'terrainMaterial.water_reflective_physical_v1', '#183f52', { roughness: 0.1, wetness: 1, nightReveal: 0.7, alpha: 1, tags: ['water', 'reflective', 'fresnel'] }),
  [MaterialProfileId.STONE_ROCK]: profile(MaterialProfileId.STONE_ROCK, MaterialFamily.TERRAIN, 'terrainMaterial.stone_rock_triplanar_pbr_v1', '#565a60', { roughness: 0.86, nightReveal: 0.56, density: 0.72, tags: ['stone', 'terrain', 'triplanar_pbr', 'reference_derived'] }),
