...
export const MATERIAL_PROFILES = Object.freeze({
  ...
  [MaterialProfileId.SOIL_GRASS]: profile(MaterialProfileId.SOIL_GRASS, MaterialFamily.TERRAIN, 'terrainMaterial.soil_grass_v0', '#314d2f', { roughness: 0.88, wetness: 0.12, nightReveal: 0.52, density: 0.44, windSway: 0.08, tags: ['soil', 'grass'] }),
  [MaterialProfileId.SOIL_DIRT]: profile(MaterialProfileId.SOIL_DIRT, MaterialFamily.TERRAIN, 'terrainMaterial.soil_dirt_v0', '#5b4732', { roughness: 0.92, wetness: 0.05, nightReveal: 0.5, density: 0.36, tags: ['soil', 'dirt'] }),
  ...
  [MaterialProfileId.SCORCHED_SOIL]: profile(MaterialProfileId.SCORCHED_SOIL, MaterialFamily.TERRAIN, 'terrainMaterial.scorched_soil_v0', '#1d1b18', { roughness: 0.98, burnAmount: 0.86, nightReveal: 0.36, density: 0.42, tags: ['ash', 'burnt'] }),
