...
export const ENEMY_ATTACK_PROFILES = Object.freeze({
  [EnemyAttackProfileId.RAIDER_SPEAR_JAB]: freezeProfile({
    ...
    recovery: 0.34,
    damageTime01: 0.44,
    hitShape: { type: EnemyHitShape.FORWARD_CAPSULE, length: 1.28, halfWidth: 0.22 },
  ...
  [EnemyAttackProfileId.RAIDER_TORCH_SWING]: freezeProfile({
    ...
    recovery: 0.42,
    damageTime01: 0.43,
    hitShape: { type: EnemyHitShape.FORWARD_ARC, radius: 1.05, arcRadians: Math.PI * 0.72 },
