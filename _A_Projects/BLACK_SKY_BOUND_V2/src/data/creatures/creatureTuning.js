...
export const WYVERN_TUNING_FIELDS = Object.freeze([
  ...
  field('stance.headHeight', 'Stance', 'Head height', 0.42, 0.82, 0.01),
  field('stance.chestHeight', 'Stance', 'Chest height', 0.22, 0.5, 0.01),
  field('stance.hipHeight', 'Stance', 'Hip height', 0.16, 0.42, 0.01),
  field('stance.wristHeight', 'Stance', 'Wrist height', 0.025, 0.14, 0.005),
  field('stance.tailTipHeight', 'Stance', 'Tail-tip height', 0.02, 0.16, 0.005),
  field('surface.headDepth', 'Body volume', 'Head depth', 0.09, 0.24, 0.005),
  field('surface.chestDepth', 'Body volume', 'Chest depth', 0.11, 0.28, 0.005),
  field('surface.torsoDepth', 'Body volume', 'Torso depth', 0.08, 0.23, 0.005),
  field('surface.hipDepth', 'Body volume', 'Hip depth', 0.1, 0.25, 0.005),
  field('surface.tailRootDepth', 'Body volume', 'Tail-root depth', 0.06, 0.18, 0.005),
  ...
  field('turning.maxRateDegreesPerSecond', 'Turning', 'Maximum rate', 300, 600, 15),
  field('turning.accelerationDegreesPerSecond2', 'Turning', 'Acceleration', 900, 3000, 100),
  field('turning.brakingDegreesPerSecond2', 'Turning', 'Braking', 1200, 3600, 100),
  field('turning.hipFollowSharpness', 'Turning', 'Hip follow', 5, 16, 0.5),
  field('turning.tailMidFollowSharpness', 'Turning', 'Tail follow', 2, 10, 0.5),
  field('turning.pivotLiftMeters', 'Turning', 'Pivot lift', 0.015, 0.06, 0.005),
