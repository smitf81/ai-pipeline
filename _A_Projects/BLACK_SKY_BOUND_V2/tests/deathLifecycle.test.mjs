...
const raiderRecipe = getComponent(game.world, raider, ComponentType.CreatureRecipe);
...
equal(corpse.sourceRecipeId, CreatureRecipeId.RAIDER_SCAVENGER, 'aftermath should resolve and preserve recipe-owned death profile provenance');
equal(corpse.sourceVariantSignature, raiderRecipe.variantSignature, 'aftermath should preserve the resolved visual-family signature');
