...
const testEntries = [
  ...
  { name: 'subconsciousDaemon', path: './subconsciousDaemon.test.mjs' },
  ...
  { name: 'ctoChiefOfStaff', path: './ctoChiefOfStaff.test.mjs' },
  { name: 'ctoAdvisoryBridge', path: './ctoAdvisoryBridge.test.mjs' },
  { name: 'chiefOfStaffStudioUi', path: './chiefOfStaffStudioUi.test.mjs' },
